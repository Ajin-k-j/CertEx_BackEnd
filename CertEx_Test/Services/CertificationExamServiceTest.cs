...
namespace CertEx_Test.Services
{
    ...
    internal class CertificationExamServiceTest
    {
        ...
        public async Task GetAllCertificationExamsAsync_ReturnsMappedCertificationExamsWithProviderNameAndTags()
        {
            ...
            {
                new CertificationExam { Id = 1, CertificationProvider = new CertificationProvider { ProviderName = "Provider1" }, CertificationTag = new List<CertificationTag> { new CertificationTag { CategoryTag = new CategoryTag { CategoryTagName = "Tag1" } } } },
                new CertificationExam { Id = 2, CertificationProvider = new CertificationProvider { ProviderName = "Provider2" }, CertificationTag = new List<CertificationTag> { new CertificationTag { CategoryTag = new CategoryTag { CategoryTagName = "Tag2" } } } }
            };
