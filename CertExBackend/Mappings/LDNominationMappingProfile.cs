    ...
    public class LDNominationMappingProfile : Profile
    {
        public LDNominationMappingProfile()
        {
            ...
            CreateMap<Nomination, LDNominationDto>()
                ...
                .ForMember(dest => dest.UploadCertificateStatus, opt => opt.MapFrom(src => src.ExamDetail.UploadCertificateStatus))
                .ForMember(dest => dest.SkillMatrixStatus, opt => opt.MapFrom(src => src.ExamDetail.SkillMatrixStatus))
                .ForMember(dest => dest.ReimbursementStatus, opt => opt.MapFrom(src => src.ExamDetail.ReimbursementStatus))
